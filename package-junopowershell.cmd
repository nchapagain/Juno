...
Echo [Packaging Juno PowerShell Module]
echo --------------------------------------------------
call dotnet pack %~dp0Juno.PowerShellModule\Juno.PowerShellModule.csproj -c Debug -p:Version=%PackageVersion% -p:GeneratePackageOnBuild=true && echo: || Goto :Error
Goto :End
