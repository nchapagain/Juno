...
{
    /// <summary>
    /// Integration test to check that FPGAReconfig provider works when the required tools are present in C:\\app
    /// </summary>
    [TestFixture]
    ...
    public class FPGAReconfigProviderTests
    {
        ...
        public void SetupTest()
        {
            ...
            this.mockFixture = new ProviderFixture(typeof(FPGAReconfigProvider));
        ...
        /// <summary>
        /// Live integration test to check that FPGAReconfig provider works when the required tools are present in C:\\app
        /// </summary>
        [Test]
        public void ProviderCanReconfigureFPGAWhenToolsArePresent()
        {
            this.mockFixture = new ProviderFixture(typeof(FPGAReconfigProvider));
            this.mockFixture.SetupExperimentMocks(ExperimentType.AB);

            var selectionProvider = new FPGAReconfigProvider(this.providerServices);
