namespace Juno.Contracts
{
    ...
    /// <summary>
    /// An instance of an <see cref="ExperimentHistoryItem"/> used for storing the experiment History
    /// in a data store.
    /// </summary>
    public class ExperimentHistoryItem : Item<ExperimentHistory>
    {
        ...
        public ExperimentHistoryItem(string id, ExperimentHistory definition)
        ...
        /// <param name="definition">The data associated with the item.</param>
        [JsonConstructor]
        public ExperimentHistoryItem(string id, DateTime created, DateTime lastModified, ExperimentHistory definition)
