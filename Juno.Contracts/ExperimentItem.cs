namespace Juno.Contracts
{
    ...
    /// in a data store.
    /// </summary>
    public class ExperimentItem : Item<Experiment>
    {
        ...
        public ExperimentItem(string id, Experiment definition)
        ...
        /// <param name="definition">The data associated with the item.</param>
        [JsonConstructor]
        public ExperimentItem(string id, DateTime created, DateTime lastModified, Experiment definition)
