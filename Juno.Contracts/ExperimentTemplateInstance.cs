namespace Juno.Contracts
{
    ...
    /// in a data store.
    /// </summary>
    public class ExperimentTemplateInstance : Item<ExperimentTemplate>
    {
        ...
        public ExperimentTemplateInstance(string id, ExperimentTemplate definition)
        ...
        /// <param name="definition">The data associated with the item.</param>
        public ExperimentTemplateInstance(string id, DateTime created, DateTime lastModified, ExperimentTemplate definition)
        ...
        [JsonConstructor]
        public ExperimentTemplateInstance(string id, DateTime created, DateTime lastModified, ExperimentTemplate definition, ExperimentStatus status)
