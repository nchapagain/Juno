namespace Juno.Execution.Providers.Workloads
{
    ...
    /// <summary>
    /// Provider is used to monitor the status of Juno agent workload steps from within
    ...
    public class MonitorAgentWorkload : ExperimentProvider, IExperimentStepMonitoringProvider
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MonitorAgentWorkload"/> class.
        /// </summary>
        /// <param name="services">The services/dependencies collection for the provider.</param>
        public MonitorAgentWorkload(IServiceCollection services)
            : base(services)
        {
        }
