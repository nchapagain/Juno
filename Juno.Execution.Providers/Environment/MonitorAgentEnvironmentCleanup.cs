namespace Juno.Execution.Providers.Environment
{
    ...
    /// <summary>
    /// Provider is used to monitor the status of Juno agent environment cleanup steps from within
    ...
    public class MonitorAgentEnvironmentCleanup : ExperimentProvider, IExperimentStepMonitoringProvider
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MonitorAgentEnvironmentCleanup"/> class.
        /// </summary>
        /// <param name="services">The services/dependencies collection for the provider.</param>
        public MonitorAgentEnvironmentCleanup(IServiceCollection services)
            : base(services)
        {
        }
