...
Echo [Packaging Juno Guest Agent]
echo --------------------------------------------------
call dotnet pack %~dp0Juno.GuestAgent\Juno.GuestAgent.csproj -c Debug -p:Version=%PackageVersion% -p:GeneratePackageOnBuild=true && echo: || Goto :Error
Goto :End
